...
export class ApiServiceService {
  ...
  loginUser(data: any) {
    ...
    return this.http.post<any>(ApiServiceService.APIURL + this.appmod, {
      "identifier": data.identifier,
      "password": data.password
    }, { headers: { "Content-Type": "application/json" }, params: { type: "main" } }).pipe(
      tap(data => data),
  ...
  changePassword(data: any, session: any) {
    ...
    }, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session }, params: { type: "main" } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  getTeam() {
    this.appmod = "teams";
    return this.http.get<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json" } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  getLocations(session: any) {
    ...
    return this.http.get<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session }, params: { type: "main" } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  sendMessage(session: string, data: any) {
    ...
    return this.http.post<any>(ApiServiceService.APIURL + this.appmod, { "data": data }, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  updateMeetup(session: string, data: any, id: any) {
    ...
    return this.http.put<any>(ApiServiceService.APIURL + this.appmod, { "data": data }, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  getAllMeetup(session: string): Observable<any> {
    this.appmod = "meetups?populate=*";
    return this.http.get<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  deleteMeetup(id: any, session: string) {
    this.appmod = "meetups/" + id;
    return this.http.delete<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  updateUserDetail(session: string, data: any, id: any) {
    ...
    return this.http.put<any>(ApiServiceService.APIURL + this.appmod, {
      "name": data.name,
    ...
    }, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  ...
  saveSearchedMeetup(data: any, session: string) {
    ...
    return this.http.post<any>(ApiServiceService.APIURL + this.appmod,
      { "data": data }, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } }).pipe(
        tap(data => data),
        catchError(async (error) => error)
      );
  }
  getSearchMeetup(session: string) {
    ...
    return this.http.get<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json", Authorization: "Bearer " + session } })
      .pipe(
        catchError(error => {
  ...
  getMeetupCards() {
    ...
    return this.http.get<any>(ApiServiceService.APIURL + this.appmod, { headers: { "Content-Type": "application/json", Authorization: "Bearer " } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
  contactUs(data: any) {
    ...
    return this.http.post<any>(ApiServiceService.APIURL + this.appmod, { "data": data }, { headers: { "Content-Type": "application/json" } }).pipe(
      tap(data => data),
      catchError(async (error) => error)
    );
  }
